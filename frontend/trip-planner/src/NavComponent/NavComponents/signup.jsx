...
const SignUp = () => {
    ...
    //     const apiResponse = await fetch(`localhost:3001/users`, {
    //         method: "POST",
    ...
    //             setUser([parsedResponse.data, ...users]);
    //             console.log(users);
    //         }
    //     } else {
    //         //else:
    ...
    return (
        <div>
            ...
            <form onSubmit={submitNewUser}>
                ...
                <input type='text' name='username' placeholder="username" value={newUser.username}></input>
